...
class Main extends Component {
    ...
    render() {
        ...
        /*
        * 如果cookie中有，说明之前登陆过（也经历过注册）。
        * 再检查 user中_id，这个是填写详细信息时，更新的
        *   如果没有，说明还没有完善详细信息
        *
        * 然后执行上面的componentDidMount，发送请求，获取数据库的 user信息
        *   执行下面的重定向。
        * */
        ...
        if(!user._id){
            ...
            //如果访问的是根路径，重定向的指定的页面（还没有做，比如对话列表什么的）
